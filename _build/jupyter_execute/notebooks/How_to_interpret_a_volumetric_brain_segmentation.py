...
Now that we have explored three dimensional parcellations a bit, lets move on to a consideration of these NIfTI datatypes are different from [tractography](https://en.wikipedia.org/wiki/Tractography) datatypes.